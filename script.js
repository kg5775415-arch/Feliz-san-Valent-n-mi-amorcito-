...
"Te amo Demasiado como no tienes idea ❤️\n\n" +
"Siempre Seras tú, mi Rossy 💖";
...
setInterval(() => rebotar("❤️😍🥰"), 1400);
setInterval(() => rebotar("👑🥹✨"), 1400);

// Mensaje al tocar pantalla
document.body.addEventListener("click", () => {
  const msg = document.createElement("div");
  msg.innerHTML = "Te amo mi rossy piciosa ❤️";
  msg.className = "toque";
  document.body.appendChild(msg);
  setTimeout(() => msg.remove(), 2000);
});
const audio = new Audio("latido.mp3");
audio.loop = true;
...
document.body.addEventListener("click", () => {
  ...
  mensaje.innerHTML = "Te amo mi piciosa ❤️";
  ...
  mensaje.style.animation = "brillo 1.5s ease-in-out infinite";
